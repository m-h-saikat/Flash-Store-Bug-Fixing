...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <button id="details-btn" onclick="productDetails('${product.description}')" class="btn btn-primary">Details</button></div>
      `;
...
const productDetails = productDetails => {
  ...
  <h3 class="text-center text-danger mt-2">Product Details</h3>
  <hr>
